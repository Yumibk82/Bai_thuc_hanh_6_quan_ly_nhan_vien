                ...
                switch (choiceMainMenu){
                    ...
                    case 5:
                        ...
                        if(employeeGetSalary != null){
                            ...
                            System.out.println(employeeGetSalary.getClass().getSimpleName()+" "+employeeGetSalary.getName()+"'s salary for this month is "+employeeGetSalary.getSalary(basicSalary,rate));
                        }
                        break;
                    case 6:
